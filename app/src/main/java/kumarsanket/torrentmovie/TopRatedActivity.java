...
public class TopRatedActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<ArrayList<Movie>>{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = (RecyclerView)findViewById(R.id.rated_recycler_view);
        refreshLayout = (SwipeRefreshLayout)findViewById(R.id.rated_refresh_layout);
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<ArrayList<Movie>>(this) {
            ...
            public ArrayList<Movie> loadInBackground() {
                ...
                //  url ---- https://yts.ag/api/v2/list_movies.json?page=15&minimum_rating=8
                String url = "https://yts.ag/api/v2/list_movies.json?page="+currentPage+"&minimum_rating=8";
                Log.v("URL ",url);
                try {
