 ...
 */
public class HistoryMovieFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movie>>{
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<ArrayList<Movie>>(getContext()) {
            ...
            public ArrayList<Movie> loadInBackground() {
                ...
                String url = "https://yts.ag/api/v2/list_movies.json?page="+currentPage+"&genre=History";
                Log.v("URL ",url);
                try {
