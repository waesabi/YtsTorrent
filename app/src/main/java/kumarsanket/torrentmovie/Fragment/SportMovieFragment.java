 ...
 */
public class SportMovieFragment extends Fragment implements LoaderManager.LoaderCallbacks<ArrayList<Movie>>{
    ...
    public Loader<ArrayList<Movie>> onCreateLoader(int id, Bundle args) {
        return new AsyncTaskLoader<ArrayList<Movie>>(getContext()) {
            ...
            public ArrayList<Movie> loadInBackground() {
                ...
                String url = "https://yts.ag/api/v2/list_movies.json?page="+currentPage+"&genre=Sport";
                Log.v("URL ",url);
                try {
